...
{
    /// <summary>
    /// Web API Controller for Notes entity defined in oaWebNotes.emWebNotes data model
    /// </summary>
    public partial class NotesController : OpenAccessBaseApiController<oaWebNotes.Note, oaWebNotes.emWebNotes>
    {
        /// <summary>
        ...
        public NotesController(IOpenAccessBaseRepository<oaWebNotes.Note, oaWebNotes.emWebNotes> repository)
        {
        ...
        public virtual oaWebNotes.Note Get(Int32 id)
        {
            oaWebNotes.Note entity = repository.GetBy(o => o.FID == id);

            if (entity == null)
            {
                //throw new HttpResponseException(HttpStatusCode.NotFound);
                Debug.WriteLine("entity = null for id " + id);
            }
        ...
        public virtual HttpResponseMessage Put(Int32 id, oaWebNotes.Note entity)
        {
            if (entity == null || id != entity.FID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, oaWebNotes.Note entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<oaWebNotes.Note>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.FID });
